...
const Article = async () => {
  ...
  return (
    <div
      ...
      <SetScrollContainer />
      <div className='pt-[5rem] pb-5 w-full gap-4 justify-center items-center flex flex-col'>

        <div className='text-center text-sm text-white px-5'>
          ik ik there is not much to see in here... I will add more detailed articles in the future especially for C
        </div>
        <Background>
