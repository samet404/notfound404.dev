...
export const SkillsCategoryDropdown = () => {
    ...
    const categories = ['All', 'Language', 'Library-framework', 'Service', 'Tool', 'Database', 'API', 'Dev tool', 'Other', "I can't take it anymore I want job "] as const
    ...
    return (
        <div className="relative  cursor-none inline-block pl-4" ref={dropdownRef}>
            <button
            ...
            {isOpen && (
                <div className="absolute z-10 mt-2 bg-[#fffffff5] backdrop-blur-sm rounded-lg shadow-lg border border-gray-200 max-h-60 overflow-auto">
                    {categories.map((cat) => {
                        ...
                        return <button
                            ...
                            className={`
                                w-full cursor-none  text-[0.9rem] px-2 py-1 text-left  hover:bg-gray-100
