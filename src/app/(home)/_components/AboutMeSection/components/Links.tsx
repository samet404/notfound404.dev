  ...
  return (
    <div className="flex flex-col flex-wrap items-center justify-center gap-4 rounded-lg  text-[0.8rem] text-[white]">
      <div className="flex flex-row flex-wrap justify-center gap-3">
        <div className="flex rounded-md bg-[#f3be00] px-2 py-1 font-[600] drop-shadow-[0_0px_4px_#f3be00d7]  ">
          Open to work
        </div>
      ...
      <div className="flex flex-row flex-wrap items-center justify-center gap-3 px-10 rounded-lg  text-[0.8rem] text-[white]">
        ...
        <ProfileLink href="https://codepen.io/samet404">
          <Image src={codepen} placeholder='blur' sizes='calc(0.7vw + 26px)' className="h-7 w-7" alt="codepen" />
        </ProfileLink>
        <Divider />
