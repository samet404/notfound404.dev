  ...
  return (
    <div className="p-2 w-full ">
      ...
      <p>
        ...
        things, drawing and so on. I'm always open to new opportunities and
        collaborations. If you want to contact me, you can always find my social
        media accounts and email listed above.
      </p>
    </div>
  )
}
